...
class TestSimpleField(unittest.TestCase):
    ...
    def setUp(self):
        self.config = {
            ...
            "field_text_format_ids": {
                "field_foo": "restricted_html",
                "field_bar": "basic_html",
            },
        }
    ...
    def test_create_with_simple_field(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "Field foo value"}],
        }
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"simple_002 would exceed maximum number of allowed values \(1\)",
            )
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "First value"}, {"value": "Second value"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "First 006 value|First 006 value|Second 006 value|Third 006 value"
            )
            # csv_record['field_foo'] = "First 006 value|Second 006 value|Third 006 value"
            self.node = field.create(
                self.config,
                self.field_definitions,
                existing_node,
                csv_record,
    ...
    def test_simple_field_title_update_append(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"record 1 would exceed maximum number of allowed values \(1\)",
            )
    ...
    def test_simple_field_update_replace_cardinality_1_no_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "Field foo original value"}],
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "Field foo new value"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_simple_field_update_replace_cardinality_1_with_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"record 2 would exceed maximum number of allowed values \(1\)",
            )
    ...
    def test_simple_field_update_replace_cardinality_unlimited_with_subdelims(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "New value 1"}, {"value": "New value 2"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_simple_field_update_append_cardinality_limited_no_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"record 8 would exceed maximum number of allowed values \(2\)",
            )
    ...
    def test_simple_field_update_replace_cardinality_limited_with_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "First node 9 value|Second node 9 value|Third node 9 value"
            )
            node = field.update(
                self.config,
                self.field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"record 9 would exceed maximum number of allowed values \(2\)",
            )
    ...
    def test_simple_field_update_append_cardinality_limited_with_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "Field foo original value 1"}],
        }
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"record 10 would exceed maximum number of allowed values \(3\)",
            )
...
class TestSimpleFieldFormatted(unittest.TestCase):
    ...
    def test_create_with_simple_field(self):
        ...
        # Create a node with a simple field of cardinality 1, no subdelimiters.
        self.field_definitions = {
            "field_foo": {"cardinality": 1, "formatted_text": True}
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "Field foo value", "format": "restricted_html"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "First value", "format": "restricted_html"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        # Create a node with a simple field of cardinality limited, no subdelimiters.
        self.field_definitions = {
            "field_foo": {"cardinality": 2, "formatted_text": True}
        }
    ...
    def test_simple_field_title_update_append(self):
        ...
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
            "title": [{"value": "Old title - append."}],
            "status": [{"value": 1, "format": "restricted_html"}],
        }

        self.field_definitions = {"title": {"cardinality": 1, "formatted_text": True}}
    ...
    def test_simple_field_update_replace_cardinality_unlimited_no_subdelims(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"value": "New value", "format": "restricted_html"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_simple_field_update_append_cardinality_limited_with_subdelims(self):
        ...
        self.field_definitions = {
            "field_foo": {"cardinality": 3, "formatted_text": True}
        }
...
class TestGeolocationField(unittest.TestCase):
    ...
    def test_create_with_geolocation_field(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "48.16667", "lng": "-123.93333"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            expected_node = {
                ...
                "title": [{"value": "Test node"}],
                "status": [{"value": 1}],
                "field_foo": [{"lat": "47.16667", "lng": "-123.93333"}],
            }
            self.assertDictEqual(node, expected_node)
            self.assertRegex(
                str(message.output),
                r"for record geo_002 would exceed maximum number of allowed values \(1\)",
            )
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "59.16667", "lng": "-123.93333"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        csv_record["field_foo"] = (
            "59.16667,-123.93333|69.16667,-123.93333|69.16667,-123.93333"
        )
        node = field.create(
            self.config, self.field_definitions, existing_node, csv_record, "field_foo"
        )
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "58.16667", "lng": "-123.93333"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "51.16667,-123.93333|61.16667,-123.93333|61.16667,-123.93333|63.16667,-123.93333|61.16667,-123.93334"
            )
            node = field.create(
                self.config,
                self.field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"for record geo_006 would exceed maximum number of allowed values \(3\)",
            )
    ...
    def test_geolocation_field_update_replace_cardinality_1_no_subdelims(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "50.16667", "lng": "-123.93333"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_geolocation_field_update_replace_cardinality_unlimited_no_subdelims(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "55.26667", "lng": "-113.93333"}],
        }
        self.assertDictEqual(node, expected_node)

    def test_geolocation_field_update_replace_cardinality_unlimited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        csv_record["field_foo"] = (
            "55.26661,-113.93331|51.26667,-111.93333|55.26661,-113.93331"
        )
        node_field_values = [{"lat": "49.16667", "lng": "-122.93333"}]
        node103 = geolocation.update(
            self.config,
            self.field_definitions,
            existing_node,
            csv_record,
    ...
    def test_geolocation_field_update_replace_cardinality_limited_no_subdelims(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "53.26667", "lng": "-133.93333"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_geolocation_field_update_replace_cardinality_limited_with_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "43.16667", "lng": "-123.63"}],
        }
        ...
        with self.assertLogs() as message:
            ...
            csv_record["node_id"] = 106
            csv_record["field_foo"] = (
                "53.26667,-133.93333|51.34,-111.1|51.51,-111.999|53.26667,-133.93333"
            )
            node = geolocation.update(
                self.config,
                self.field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"for record 106 would exceed maximum number of allowed values \(2\)",
            )
    ...
    def test_geolocation_field_update_append_cardinality_limited_no_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 107 would exceed maximum number of allowed values \(1\)",
            )
    ...
    def test_geolocation_field_update_replace_cardinality_limited_with_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"lat": "49.16667", "lng": "-122.93333"}],
        }
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "55.80,-113.80|55.82,-113.82|55.82,-113.82|55.83,-113.83"
            )
            node = geolocation.update(
                self.config,
                self.field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"for record 108 would exceed maximum number of allowed values \(2\)",
            )
    ...
    def test_geolocation_field_update_append_cardinality_limited_with_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "55.90,-113.90|55.92,-113.92|55.92,-113.92|55.93,-113.93"
            )
            node = geolocation.update(
                self.config,
                self.field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"for record 109 would exceed maximum number of allowed values \(2\)",
            )
...
class TestLinkField(unittest.TestCase):
    ...
    def test_create_with_link_field(self):
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"uri": "http://www.foo.com", "title": "Foo's website"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            expected_node = {
                ...
                "title": [{"value": "Test node"}],
                "status": [{"value": 1}],
                "field_foo": [{"uri": "http://bar.com", "title": "Bar website"}],
            }
            self.assertDictEqual(node, expected_node)
            self.assertRegex(
                str(message.output),
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"uri": "http://geo003.net", "title": "Geo 3 Blog"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"uri": "http://link5.net", "title": "Link 005 website"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_link_field_update_replace_cardinality_1_no_subdelims(self):
        existing_node = {
            ...
            "status": [{"value": 1}],
            "field_foo": {
                "uri": "http://update1original.net",
                "title": "Update 1 original's website",
            },
        }
        ...
        expected_node = {
            ...
            "field_foo": [
                {
                    "uri": "http://update1replacement.net",
                    "title": "Update 1 replacement's website",
                }
            ],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_link_field_update_replace_cardinality_1_with_subdelims(self):
        existing_node = {
            ...
            "status": [{"value": 1}],
            "field_foo": {
                "uri": "http://update2original.net",
                "title": "Update 2 original's website",
            },
        }
        ...
        with self.assertLogs() as message:
            ...
            expected_node = {
                ...
                "field_foo": [
                    {
                        "uri": "http://update2replacement.net",
                        "title": "Update 2 replacement's website",
                    }
                ],
            }
            self.assertDictEqual(node, expected_node)
    ...
    def test_link_field_update_replace_cardinality_unlimited_no_subdelims(self):
        existing_node = {
            ...
            "status": [{"value": 1}],
            "field_foo": {
                "uri": "http://updatenode102original.net",
                "title": "Update node 102 original's website",
            },
        }
        ...
        expected_node = {
            ...
            "field_foo": [
                {
                    "uri": "http://updatenode102replace.net",
                    "title": "Update to node 102 replacement's website",
                }
            ],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_link_field_update_replace_cardinality_unlimited_with_subdelims(self):
        existing_node = {
            ...
            "status": [{"value": 1}],
            "field_foo": {
                "uri": "http://updatenode103original.net",
                "title": "Update node 103 original's website",
            },
        }
        ...
        expected_node = {
            ...
            "field_foo": [
                {
                    "uri": "http://updatenode103replace1.net",
                    "title": "103 replacement 1",
                },
                {
                    "uri": "http://updatenode103replacement2.net",
                    "title": "103 replacement 2",
                },
            ],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_link_field_update_append_cardinality_unlimited_no_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"uri": "http://node104o.net", "title": "Node 104 o"}],
        }
    ...
    def test_link_field_update_replace_cardinality_limited_with_subdelims(self):
        ...
        node_field_values = [
            {"uri": "http://111o-1.net", "title": "Node 111 1 original"},
            {"uri": "http://111o-2.net", "title": "Node 111 2 original"},
        ]
        node = field.update(
            self.config,
            self.field_definitions,
    ...
    def test_link_field_update_delete(self):
        ...
        node_field_values = [
            {"uri": "http://112o-1.net", "title": "Node 112 1 original"},
            {"uri": "http://112o-2.net", "title": "Node 112 2 original"},
        ]
        node = field.update(
            self.config,
            self.field_definitions,
...
class TestEntityRefererenceField(unittest.TestCase):
    ...
    def test_create_with_entity_reference_field(self):
        ...
        self.field_definitions = {
            "field_foo": {"cardinality": 1, "target_type": "taxonomy_term"}
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "10", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)

        self.field_definitions = {
            "field_foo": {"cardinality": 1, "target_type": "node"}
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "10", "target_type": "node_type"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            expected_node = {
                ...
                "title": [{"value": "Test node"}],
                "status": [{"value": 1}],
                "field_foo": [{"target_id": "101", "target_type": "taxonomy_term"}],
            }
            self.assertDictEqual(node, expected_node)
            self.assertRegex(
                str(message.output),
                r"for record term_entity_reference_002 would exceed maximum number of allowed values \(1\)",
            )
        ...
        with self.assertLogs() as message:
            ...
            expected_node = {
                ...
                "title": [{"value": "Test node"}],
                "status": [{"value": 1}],
                "field_foo": [{"target_id": "100", "target_type": "node_type"}],
            }
            self.assertDictEqual(node, expected_node)
            self.assertRegex(
                str(message.output),
                r"for record node_entity_reference_002 would exceed maximum number of allowed values \(1\)",
            )
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "1010", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "10001", "target_type": "node_type"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        # for both taxonomy term and node references.
        self.field_definitions = {
            "field_foo": {"cardinality": 2, "target_type": "taxonomy_term"}
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "101010", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "1010101", "target_type": "node_type"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record term_entity_reference_006 would exceed maximum number of allowed values \(2\)",
            )

        self.field_definitions = {
            "field_foo": {"cardinality": 2, "target_type": "node"}
        }
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record node_entity_reference_006 would exceed maximum number of allowed values \(2\)",
            )
    ...
    def test_entity_reference_field_update_replace_cardinality_1_no_subdelims(self):
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "1", "target_type": "taxonomy_term"}],
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "5", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "20", "target_type": "node_type"}],
        }
        self.assertDictEqual(node, expected_node)
    ...
    def test_entity_reference_field_update_replace_cardinality_1_with_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 102 would exceed maximum number of allowed values \(1\)",
            )
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 103 would exceed maximum number of allowed values \(1\)",
            )

    def test_entity_reference_field_update_replace_cardinality_unlimited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "40", "target_type": "taxonomy_term"}],
        }
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "30", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "40", "target_type": "node_type"}],
        }
        self.assertDictEqual(node, expected_node)

    def test_entity_reference_field_update_replace_cardinality_unlimited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "50", "target_type": "taxonomy_term"}],
        }
    ...
    def test_entity_reference_field_update_append_cardinality_unlimited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "70", "target_type": "taxonomy_term"}],
        }
    ...
    def test_entity_reference_field_update_append_cardinality_unlimited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "71", "target_type": "node_type"}],
        }
    ...
    def test_entity_reference_field_update_replace_cardinality_limited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        expected_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "112", "target_type": "taxonomy_term"}],
        }
        self.assertDictEqual(node, expected_node)

    def test_entity_reference_field_update_append_cardinality_limited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 113 would exceed maximum number of allowed values \(2\)",
            )

        # Do not violate cardinality.
        self.field_definitions = {
            "field_foo": {"cardinality": 3, "target_type": "taxonomy_term"}
        }
        ...
        existing_node = {
            ...
            "title": [{"value": "Test node"}],
            "status": [{"value": 1}],
            "field_foo": [{"target_id": "60", "target_type": "node_type"}],
        }
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 1141 would exceed maximum number of allowed values \(2\)",
            )

    def test_entity_reference_field_update_replace_cardinality_limited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record 116 would exceed maximum number of allowed values \(2\)",
            )
        ...
        with self.assertLogs() as message:
            self.field_definitions = {
                "field_foo": {"cardinality": 3, "target_type": "node"}
            }
            ...
            self.assertRegex(
                str(message.output),
                r"for record 1161 would exceed maximum number of allowed values \(3\)",
            )

    def test_entity_reference_field_update_append_cardinality_limited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        # Do not violate cardinality.
        self.field_definitions = {
            "field_foo": {"cardinality": 4, "target_type": "taxonomy_term"}
        }
...
class TestTypedRelationField(unittest.TestCase):
    ...
    def test_create_with_typed_relation_field(self):
        ...
        node = field.create(
            self.config, field_definitions, self.existing_node, csv_record, "field_foo"
        )
        expected_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
            "title": [{"value": "Test node"}],
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_002 would exceed maximum number of allowed values \(1\)",
            )
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "relators:art:26|relators:art:36|relators:art:46|relators:art:56"
            )
            node = field.create(
                self.config,
                field_definitions,
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_006 would exceed maximum number of allowed values \(3\)",
            )
    ...
    def test_typed_relation_field_update_replace_cardinality_1_with_subdelims(self):
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_008 would exceed maximum number of allowed values \(1\)",
            )

    def test_typed_relation_field_update_replace_cardinality_unlimited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
    ...
    def test_typed_relation_field_update_replace_cardinality_unlimited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        expected_node = {
            ...
            "field_foo": [
                ...
                {
                    "rel_type": "relators:bbb",
                    "target_id": "903",
                    "target_type": "taxonomy_term",
                },
                {
                    "rel_type": "relators:ccc",
                    "target_id": "904",
                    "target_type": "taxonomy_term",
                },
            ],
    ...
    def test_typed_relation_field_update_append_cardinality_unlimited_no_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
    ...
    def test_typed_relation_field_update_append_cardinality_limited_no_subdelims(self):
        existing_node = {
            ...
            "field_foo": [
                {
                    "rel_type": "relators:yyy",
                    "target_id": "140",
                    "target_type": "taxonomy_term",
                },
                {
                    "rel_type": "relators:zzz",
                    "target_id": "141",
                    "target_type": "taxonomy_term",
                },
            ],
        ...
        with self.assertLogs() as message:
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_014 would exceed maximum number of allowed values \(2\)",
            )

    def test_typed_relation_field_update_replace_cardinality_limited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "relators:bbb:150|relators:ccc:152|relators:ccc:152|relators:ddd:153"
            )
            node_field_values = [
                {
                    "rel_type": "relators:art",
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_015 would exceed maximum number of allowed values \(2\)",
            )

    def test_typed_relation_field_update_append_cardinality_limited_with_subdelims(
        self,
    ):
        existing_node = {
            "type": [{"target_id": "islandora_object", "target_type": "node_type"}],
        ...
        with self.assertLogs() as message:
            ...
            csv_record["field_foo"] = (
                "relators:rrr:160|relators:sss:161|relators:sss:161|relators:ttt:162"
            )
            node = field.update(
                self.config,
                self.field_definitions,
            ...
            expected_node = {
                ...
                "field_foo": [
                    ...
                    {
                        "rel_type": "relators:rrr",
                        "target_id": "160",
                        "target_type": "taxonomy_term",
                    },
                    {
                        "rel_type": "relators:sss",
                        "target_id": "161",
                        "target_type": "taxonomy_term",
                    },
                ],
            ...
            self.assertRegex(
                str(message.output),
                r"for record typed_relation_016 would exceed maximum number of allowed values \(3\)",
            )
    ...
    def test_entity_reference_field_dudupe_values(self):
        # Split values from CSV.
        input = [
            "relators:art:person:Bar, Foo",
            "relators:art:person:Bang, Biz",
            "relators:art:person:Bang, Biz",
        ]
        field = workbench_fields.LinkField()
        output = field.dedupe_values(input)
